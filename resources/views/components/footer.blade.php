        ...
        <div class="row gy-4 align-items-start">
            ...
            <div class="col-lg-8">
                <nav class="footer-nav" aria-label="Navegação do rodapé">
                    <a href="{{ url('/#inicio') }}">Sobre</a><a href="{{ url('/#aprender') }}">Educação financeira</a><a href="{{ url('/#investimentos') }}">Investimentos</a><a href="#">Termos</a><a href="#">Privacidade</a><a href="#academic-note">Projeto acadêmico</a>
                </nav>
            </div>
        </div>
