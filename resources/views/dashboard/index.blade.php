...
@section('content')
    ...
    <section class="dashboard-content" aria-labelledby="dashboard-resources-title">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-xl-3"><article class="dashboard-card h-100"><span class="card-icon" aria-hidden="true">01</span><span class="badge text-bg-light">Em breve</span><h3>Aprenda sobre finanças</h3><p>Construa sua base com conteúdos de educação financeira.</p></article></div>
                <div class="col-md-6 col-xl-3"><article class="dashboard-card h-100"><span class="card-icon" aria-hidden="true">02</span><span class="badge text-bg-light">Em breve</span><h3>Conheça investimentos</h3><p>Entenda características, riscos e diferenças entre modalidades.</p></article></div>
